...
export const AutoretNewCurve = () => {
  return (
    ...
    >
      <g id="js_x26_react">
        <g>
          <svg className={styles['autoret-js-g']}>
            <circle
              className={styles['autoret-js']}
              cx="276.9"
              cy="586.8"
              r="40.3"
              fill="#fcdc00"
            />
            <path
              className={styles['autoret-js-leters']}
          ...
          <svg className={styles['autoret-react']}>
            <path
      ...
      <svg className={styles['autoret-face-g']} id="Ret">
