    ...
    <MainLayout idSection={'works'}>
      <section className={styles['experience-container-text']}>
        ...
        <p>
          ...
          newsrooms did not require a team of programmers to update their sites
          all the time, reducing development costs by 80%, in addition to
          improving performance by 30% on average, using technologies such as
          Next, allowing SSR or CSR in a selective manner among other
          advantages.
          <br />
          <code>
